...
CREATE UNIQUE INDEX idx_dunning_attempts_user_id_id ON dunning_attempts(user_id, id);
...
CREATE UNIQUE INDEX idx_dunning_tokens_attempt_unused
...
DROP INDEX IF EXISTS idx_dunning_tokens_attempt_unused;
...
DROP INDEX IF EXISTS idx_dunning_attempts_user_id_id;
